...
#ifndef INCLUDE_GPSHELPER_HPP_
#define INCLUDE_GPSHELPER_HPP_
#include <TinyGPS++.h>
...
const double FILTER_RADIUS {0.010};  // Radius in km to be ignored for distance calc
